...
const char* ssid     = "bbldr"; // Your SSID (Name of your WiFi)
const char* password = "melonijo1315"; //Your Wifi password

const char* host = "api.thingspeak.com";
String api_key = "Y8S0JS7M1KWHYBIP"; // Your API Key provied by thingspeak
